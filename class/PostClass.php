...
//         user_details.user_id, user_details.bday, user_details.gender, user_details.profile,
        try {
            ...
            user_details.user_id as user_d_user_id, ANY_VALUE(user_details.bday) as bday, 
            ANY_VALUE(user_details.gender) as gender, ANY_VALUE(user_details.profile) as profile,
